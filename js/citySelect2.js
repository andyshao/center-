 ...
 */
 ...
 CitySelect.prototype = {
	...
	_provFunc: function(){
		...
		var elemHtml = '';
		elemHtml+= '<option value="-1" data-name="请选择" selected disabled>请选择</option>';
	...
	_cityFunc: function(){
		...
		var opthtml = '<option value="-1" data-name="请选择" selected disabled>请选择</option>';
		...
		citys = prov[2];
		elemHtml += '<option value="-1" data-name="请选择" disabled>请选择</option>';
    ...
    _changeSetCode: function(selectId){
		...
		var html = "<option data-name='请选择' value='-1' selected disabled>请选择</option>",
			provOpt = $($(_config.provId + ' option')[0]).attr("value");
